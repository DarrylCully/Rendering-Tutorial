...
int main()
{
	...
	// build and compile shaders
	 //-------------------------
	Shader frameBufferShader("FramebufferVS.txt", "FramebufferFS.txt"); // framebuffer shader
	Shader frameBufferScreenShader("FramebufferScreenVS.txt", "FramebufferScreenFS.txt");
	...
	Shader GeoShader("VS_Geo.txt", "FS_Geo.txt", "GS_Geo.txt");
	//Shader LightShader("LightingVS.txt", "LightingFS.txt");
	//Shader shader("cubemapVS.txt", "cubemapFS.txt");
	Shader Skyboxshader("SkyboxVS.txt", "SkyboxFS.txt");
	Shader ModelLoading("LoadModelVS.txt", "LoadModelFS.txt");
	...
	unsigned int diffuseMapping = loadTexture("Textures/container2.png");
	...
	////FRAMEBUFFER CONFIG FOR TOON SHADER
	...
	Model Comp("E1M1//Comp.obj");
	Model back("E1M1//swd.obj");
	...
	GeoShader.SetInt("tex_diffuse1", 0);
...
//----------------------------------------------------
		...
		//bp.Draw(shaderParallaxMapping, &model);
...
//////ENABLE TOON SHADER
		...
		//ToonShader.SetVec3("lightDir", lightPos);
		//bp.Draw(ToonShader, &model);
